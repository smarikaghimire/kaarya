...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      {/* Outer Wrapper */}
      <div className="max-w-[1380px] mx-auto bg-gradient-to-b from-[#d4f4e7] from-0% via-[#d4f4e7] via-[420px] to-white to-[420px] rounded-none shadow-none overflow-visible px-6 py-12 sm:px-12 sm:py-16 lg:px-16 relative min-h-[900px]">
        {/* Header */}
